// ============================================================
//  COMPLIANCE API - ULTIMATE VALIDATION (v3)
//  Includes UN Sanctions, DGTrésor, and OpenCorporates
// ============================================================
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (typeof body === 'object') {
        ...
        if (body.results?.officers) console.log(`    Officers found: ${body.results.officers.length}`);
      }
...
async function run() {
  // 1. OpenCorporates Officers (NEW)
  await testApi('OpenCorporates Officers', 'https://api.opencorporates.com/v0.4/officers/search?q=Putin');
  ...
  console.log('\n' + '='.repeat(56));
  console.log('   ULTIMATE VALIDATION SUMMARY');
